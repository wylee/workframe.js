import { Render, OnMountAction, OnRenderAction, AnyState } from "./typedefs";
export default class Component<S extends AnyState> {
    ...
    constructor(state: S, mountPoint: Element, renderer: Render<S>, onMountActions: OnMountAction<S>[], onRenderActions: OnRenderAction<S>[]);
    /**
     * Get state value.
     *
     * @param name
